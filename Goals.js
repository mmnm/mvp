...
/* Created Helper functions. To reach these solutions, i had to start 
with non-recursive simple iterative solutions and then build my solutions up 
from there, using more and more callbacks and prior created functions as re-use */
...
var myFunction = function() {
  ...
  var transformed30 = "IF you increase the efforts by 30 % modulo inverse which is mathematically considered sum-optimal increased efficiency (Br theorem), then the below reflects the new time allotment for this increased level of transformation:                ";
...
var median_time = taskTotalHours / item_count;
  ...
  var filteredtext = "These tasks require your attention; they are more than the median modeling and have scientifically more risks to non-completition. Please check these tasks again. Here are those tasks:           ";
